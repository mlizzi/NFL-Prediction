...
if __name__ == '__main__':
    ...
    ######################## SETUP STAGE ########################
    # Set data to use
    indexStats = ['seasonNumber', 'week', 'home', 'away'] # Stats to index database by (not used in network)
    ...
    for year in range(2008, 2011):
        ...
        resultsDict = {'trainLoss': epochTrainLoss, 'trainAccuracy': epochTrainAccuracy, 'testLoss': epochTestLoss, 'testAccuracy': epochTestAccuracy}
        ...
        for i in range(1000):
            ...
            if not os.path.exists(modelFolder):
                ...
                torch.save(model.state_dict(), os.path.join(modelFolder, plotName.replace('.png', '.pt')))
